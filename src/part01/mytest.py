...
PATH = "./part1_opentest/functional_test"
COMP_COMMAND = "./build/compiler -S -e {0}/{1}.sy -o {0}/{1}.ir"
MINIVM_COMMAND = "../MiniVM/build/minivm {0}/{1}.ir > {0}/{1}.myout"
MINIVM_COMMAND_V2 = "../MiniVM/build/minivm {0}/{1}.ir < {0}/{1}.in > {0}/{1}.myout"
